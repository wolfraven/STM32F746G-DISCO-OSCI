...
C_SRCS += \
../Gui/Core/audio_player/audio_player_win.c 

OBJS += \
./Gui/Core/audio_player/audio_player_win.o 

C_DEPS += \
./Gui/Core/audio_player/audio_player_win.d 


# Each subdirectory must supply rules for building sources it contributes
Gui/Core/audio_player/%.o: ../Gui/Core/audio_player/%.c
	@echo 'Building file: $<'
